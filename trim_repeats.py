...
with open(f'analysis/{language}/RESULT_{language}.txt', 'r', encoding='utf-8') as f:
    L=f.readlines()
...
with open(f'analysis/{language}/RESULT_{language}_trimmed.txt', 'w', encoding='utf-8') as f:
    f.write(result)    
